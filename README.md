...
# What I Learned
This exercise provided hands-on experience in executing an end-to-end incident response workflow. 
Key takeaways include: 

Traffic Isolation: I practiced using specific Wireshark display filters, such as (http.request or tls.handshake.type eq 1) and !(ssdp) and ip.addr eq 45.131.214.85, to successfully isolate malicious command-and-control (C2) traffic.  
